...
function seedPortfolio(): Portfolio {
  ...
  const content: PortfolioContent = {
    ...
    profile: {
      ...
      email: "asad@careeros.ai",
      phone: "+92 300 1234567",
      website: "https://asad.dev",
      linkedin: "https://linkedin.com/in/asadrahman",
      github: "https://github.com/asadrahman",
      socials: [{ id: uid(), label: "X", url: "https://x.com/asadbuilds" }],
    },
    hero: {
      headline: "Hi, I'm Asad.",
    ...
    projects: [
      {
        ...
        role: "Frontend lead",
        githubUrl: "https://github.com/asadrahman/atlas",
      ...
      },
      {
        ...
        githubUrl: "https://github.com/asadrahman/pulse",
        liveUrl: "",
        images: [],
        videoUrl: "",
        date: "2024-08",
    ...
    testimonials: [
      {
        ...
        photoUrl: "",
        quote:
          "Asad raised the bar for frontend quality across the whole org. He turns vague product goals into shippable, accessible interfaces.",
  ...
  return {
    ...
    content,
    seo: {
      title: "Asad Rahman — Senior Frontend Engineer",
      description:
        "Portfolio of Asad Rahman, a senior frontend engineer building fast, accessible product interfaces.",
      keywords: ["frontend engineer", "react", "typescript", "design systems"],
      ogImage: "",
      favicon: "",
      canonicalUrl: "https://careeros.ai/asadrahman",
      indexable: true,
    },
    domain: { slug: "asadrahman", mode: "path", customDomain: "", domainStatus: "none" },
...
function seedDraft(): Portfolio {
  ...
  return {
    ...
    sections: defaultSections(),
    domain: { slug: "asad-freelance", mode: "path", customDomain: "", domainStatus: "none" },
