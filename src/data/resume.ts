...
"modern": {
  ...
  achievements: [
    {
      id: "ach1",
      title: "Reduced production cost by 20% in the second year of internship",
      organization: "",
      date: "2013 – 2015",
      description: "",
      metrics: "",
    ...
    {
      id: "ach2",
      title: "Managed five projects worth over $100 million",
      organization: "",
      date: "2015 – 2020",
      description: "",
      metrics: "",
...
"developer": {
  personal: {
    ...
    title: "Senior Backend Designer - Distributed Systems",
    email: "james.porter@example.com",
    phone: "+1 (555) 123-4567",
    location: "San Francisco, CA",
    website: "jamesporter.dev",
    linkedin: "linkedin.com/in/jamesporter",
    github: "github.com/jamesporter",
    photoUrl: "",
    twitter: "",
    behance: "",
    dribbble: "",
  ...
  summary: {
    summary: "Backend engineer with 8 years building distributed systems at scale. Strong opinions on observability, weakly held opinions on tooling. Currently shipping at Vertex.",
    objective: "",
  },
  experience: [
    {
      ...
      responsibilities: [],
      achievements: [
        "Led payments platform migration to event-driven microservices. p99 latency 840ms → 120ms across 14 services. Mentor of 6.",
      ],
    },
    {
      id: uid(),
      ...
      responsibilities: [],
      achievements: [
        "Built order pipeline handling 2M+ daily transactions. Designed rate-limiting infra now used platform-wide.",
      ],
    },
    {
      id: uid(),
      role: "Software Engineer",
      company: "Gravity Soft",
      location: "",
      employmentType: "Full-time",
      startDate: "2018-01",
      endDate: "2020-01",
  ...
  education: [],
  skills: [
    { id: uid(), name: "Go", category: "Technical Skills", level: 5 },
    { id: uid(), name: "Python", category: "Technical Skills", level: 5 },
    { id: uid(), name: "TypeScript", category: "Technical Skills", level: 4 },
    { id: uid(), name: "Kubernetes", category: "Technical Skills", level: 5 },
    { id: uid(), name: "Terraform", category: "Technical Skills", level: 4 },
    { id: uid(), name: "AWS", category: "Technical Skills", level: 5 },
  ],
  projects: [],
  certifications: [],
  achievements: [],
...
"corporate": {
  ...
  summary: {
    summary: "I am a qualified and professional web development with five years of experience in database administration and website design. Strong creative and analytical skills. Team player with an eye for detail.",
    objective: "",
  },
  experience: [
    {
  ...
  skills: [
    { id: uid(), name: "Web Design", category: "Technical Skills", level: 5 },
    { id: uid(), name: "Design Thinking", category: "Technical Skills", level: 4 },
    { id: uid(), name: "Wireframe Creation", category: "Technical Skills", level: 4 },
    { id: uid(), name: "Front End Coding", category: "Technical Skills", level: 5 },
    { id: uid(), name: "Backend Tech", category: "Technical Skills", level: 4 },
    { id: uid(), name: "Problem-Solving", category: "Soft Skills", level: 5 },
    { id: uid(), name: "Computer Literacy", category: "Technical Skills", level: 4 },
    { id: uid(), name: "Project Management Tools", category: "Tools", level: 4 },
    { id: uid(), name: "Strong Communication", category: "Soft Skills", level: 5 },
  ],
  projects: [],
  certifications: [],
  achievements: [],
